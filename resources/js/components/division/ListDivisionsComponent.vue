...
export default {
    ...
    computed: {
        divisions: {
            get() {
                return this.$store.state.division.divisions;
            },
        },
        formTitle() {
    ...
    methods: {
        ...
        deleteItemConfirm() {
            this.divisions.splice(this.editedIndex, 1);
            this.$store
                .dispatch("deleteDivision", this.editedItem)
                .then((res) => {
        ...
        save() {
            ...
            if (this.editedIndex > -1) {
                ...
                this.$store
                    .dispatch("registerDivision", formData)
                    .then((res) => {
                        this.$store.dispatch("getDivisions");
                    })
                    .catch((error) => {
